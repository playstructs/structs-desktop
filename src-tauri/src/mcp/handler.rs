        ...
        vec![
            ...
            Tool::new(
                ...
                schema(serde_json::json!({
                    "type": "object",
                    "properties": {
                        "command": { "type": "string", "enum": ["list", "roster", "create", "state", "act", "capacity", "role", "economy", "infra", "harvest", "autobuild", "autodefend", "autoresponse", "autoraid", "infuse"] },
